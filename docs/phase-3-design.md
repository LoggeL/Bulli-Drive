...
**Stand:** 2026-09-25 · **Branch:** `map/phase-3` (auf `main` 880f959, nach Phase 2 und dem Three-Upgrade r186; M1, M3, M4 und M5 umgesetzt, offen sind der Release von M5 und M6; Abweichungen A1–A73 in Abschnitt 18) · Bezug: [`refactor-plan.md`](refactor-plan.md) Abschnitt 0 (Entscheidung 3), 5 (Phase 3), 6 (Determinismus) · Grundlagen: [`phase-1a-design.md`](phase-1a-design.md) (Sim, Collider), [`phase-1b-design.md`](phase-1b-design.md) (`MapData`, `worldHash`), Phase 2 (`docs/phase-2-design.md` auf `game/phase-2-racing`: `TrackDef`, Gates, Ideallinie), [`world-look.md`](world-look.md) (Look, Tiers, Draw Calls), [`assets.md`](assets.md) (Pipeline, Budgets)
