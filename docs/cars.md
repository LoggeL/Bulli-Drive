...
- `tests/e2e/models.spec.ts`: Der Software-Tier lädt LOD1 und LOD2 aller fünf Autos. Das eigene Auto zeigt den GLB-Körper (Software-Tier: LOD1), kein Material ist eine geteilte Vorlage, Maßstab und Maße stimmen. Ein Auto 100 m entfernt wechselt auf LOD2. Käfer, Pritsche, 356 und 181 kommen als GLB mit eigenen Materialien und den Maßen aus der Tabelle oben. Ohne Manifest bleibt der Bulli prozedural.
