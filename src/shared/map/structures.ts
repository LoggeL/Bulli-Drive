...
export const KIT_FOOTPRINTS = {
    ...
    downtown_b3_f2_corner: { minX: -6, maxX: 6, minZ: -14, maxZ: 0, height: 9 },
    downtown_b4_f3_corner: { minX: -8, maxX: 8, minZ: -18, maxZ: 0, height: 12.5 },
    revival_b3_f2_mission_corner: { minX: -6, maxX: 6, minZ: -14, maxZ: 0, height: 10.28 },
    ...
    industrial_b8_d36_cannery: { minX: -24, maxX: 24, minZ: -36, maxZ: 0, height: 14.36 },
